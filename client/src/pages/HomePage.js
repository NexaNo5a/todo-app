...
const HomePage = ({userId, token}) => {
    ...
    return (
        <>
            <div className="flex h-screen"> {/* 新增：页面容器 */}
                <div className="w-64 flex-shrink-0 overflow-y-auto bg-indigo-600"> {/* 修改：固定宽度和flex-shrink-0 */}
                    <div className="px-6"> {/* 移除了 flex grow */}
                                ...
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        <li>
                                            ...
                                            <a href="#" class="group flex gap-x-3 rounded-md bg-indigo-700 p-2 text-sm font-semibold leading-6 text-white">
                                        ...
                                        <li>
                                            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-indigo-200 hover:bg-indigo-700 hover:text-white">
                ...
                <div className="flex-1 p-4"> {/* 新增：主要内容区域 */}
                    {/* 这里放置您的主要页面内容 */}
